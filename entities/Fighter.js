...
function Fighter(game, theCarrier, newFighter) {
	...
	if (newFighter == undefined) {
		...
		this.TeamNumber = newFighter.TeamNumber;
		this.color = newFighter.color;
		var xSpawn = newFighter.x;
		var ySpawn = newFighter.y;
		Entity.call(this, game, xSpawn, ySpawn);
		this.velocity = newFighter.velocity;
		this.health = newFighter.health;
		this.kills = newFighter.kills;
		this.shootingCooldown = newFighter.shootingCooldown;
	}
